...
/*
This FileAPI class provides static methods for creating and deleting files, 
checking if a file exists, reading lines from a file, and writing lines to a file.
*/
class FileManager {
public:
